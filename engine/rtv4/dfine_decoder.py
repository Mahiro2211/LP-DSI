...
class TransformerDecoder(nn.Module):
    ...
    def forward(self,
        ...
        for i, layer in enumerate(self.layers):
            ...
            inter_ref_bbox = distance2bbox(ref_points_initial, integral(pred_corners, project), reg_scale_out)
        ...
        return torch.stack(dec_out_bboxes), torch.stack(dec_out_logits), \
               torch.stack(dec_out_pred_corners), torch.stack(dec_out_refs), pre_bboxes, pre_scores, reg_scale_out, output
...
class DFINETransformer(nn.Module):
    ...
    def forward(self, feats, targets=None):
        ...
        # decoder
        out_bboxes, out_logits, out_corners, out_refs, pre_bboxes, pre_logits, reg_scale_out, final_contents = self.decoder(
            init_ref_contents,
